...
export const sendOtp = async (email: string) => {
  try {
    const response = await noTokenAxios.post("/send-otp", { email });
...
export const resendOtp = async (email: string) => {
  try {
    const response = await noTokenAxios.post("/resend-otp", { email });
    return response.data;
  } catch (error) {
    throw error;
  }
...
export const verifyOtp = async (otp: string, email: string) => {
  try {
    const response = await noTokenAxios.patch("/verify-otp", { otp, email });
    return response.data;
  } catch (error) {
    throw error;
  }
...
export const signUp = async (data: any) => {
  try {
    const response = await noTokenAxios.post("/sign-up", data);
...
export const socialAuth = async (data: any) => {
  ...
  try {
    const response = await noTokenAxios.post("/google-signup", data);
