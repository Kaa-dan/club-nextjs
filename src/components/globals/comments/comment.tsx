...
//     comment.like.some((id) => id === globalUser?._id)
//   );
//   const [isDisLiked, setIsDisLiked] = useState<boolean>(
//     comment.dislike.some((id) => id === globalUser?._id) // Changed from like to dislike
//   );
...
//     try {
//       const res = await Endpoints.putLikeComment(replyId);
//       if (res?.data) {
//         setComments(
//           comments?.map((comment) => {
...
//     }
//   };
//   const handleReplyDisLike = async (commentId: string, replyId: string) => {
//     try {
//       const res = await Endpoints.putDislikeComment(replyId);
//       if (res?.data) {
//         setComments(
//           comments?.map((comment) => {
//             if (comment._id === commentId) {
...
//   useEffect(() => {
//     setIsLiked(comment?.like?.some((id) => id === globalUser?._id));
//     setIsDisLiked(comment?.dislike?.some((id) => id === globalUser?._id));
//   }, [comment]);
...
//               className={cn("size-4 cursor
//                 -pointer text-primary", {
//                 "fill-current": isLiked,
//               })}
//             />
//             <span className="text-sm">{comment?.like?.length}</span>
//           </div>
//           <div className="flex items-center gap-1">
//             <ThumbsUp
//               onClick={() => handleDisLike(comment?._id)}
//               className={cn("size-4 rotate-180 cursor-pointer text-red-400", {
//                 "fill-current": isDisLiked,
//               })}
//             />
//             <span className="text-sm">{comment?.dislike?.length}</span>
//           </div>
...
//                             }
//                             className={cn(
//                               "size-4 cursor-pointer text-primary",
//                               {
//                                 "fill-current": isLiked,
//                               }
//                             )}
//                           />
//                           <span className="text-sm">{reply?.like?.length}</span>
//                         </div>
//                         <div className="flex items-center gap-1">
